...
namespace TextAdventureGame.Items
{
    public class WaterBottle : Item
    {
        ...
        public InputAction Use(InputAction action, string roomName)
        {
            ...
            {
                HasWater = true;
                Start.PrintLine("As you turn the knobs on the sink and the shower, a puff of dust shoots out. The pipes rattle violently but no water springs forth." +
            ...
            {
                HasWater = true;
                Start.PrintLine("The fridge is empty. The icemaker shudders and spits out crumbs of ice. The sink roars and rattles but yields no water." +
            ...
            if (HasWater)
            {
                ...
                {
                    HasWater = true;
                    Start.PrintLine("Your hands shake from the sugar as you press the bottle to your lips. With a heave, you throw back your head as the water rushes down your throat." +
                    ...
                    if (Fills < 2)
                    {
                        Start.PrintLine("You drain the bottle before you know it and strap it back to your tool belt.");
                    }
                    else
                    {
                        Start.PrintLine("You guzzle the water voraciously. So voraciously, that you crumple your water bottle. Thanks for your help, old friend, but this is where your journey ends." +
